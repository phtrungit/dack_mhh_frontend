                ...
                <div className="footer_column_content">
                  <ul>
                    <li className="footer_contact_item">
                      ...
                      <img src= {require('../images/placeholder.svg')} alt="https://www.flaticon.com/authors/lucy-g" />
                      </div>
                      Blvd Libertad, 34 m05200 Arévalo
                    </li>
                    <li className="footer_contact_item">
                      <div className="footer_contact_icon">
                      <img src= {require('../images/smartphone.svg')} alt="https://www.flaticon.com/authors/lucy-g" />
                      </div>
                      0034 37483 2445 322
                    </li>
                    <li className="footer_contact_item">
                      <div className="footer_contact_icon">
                      <img src= {require('../images/envelope.svg')} alt="https://www.flaticon.com/authors/lucy-g" />
