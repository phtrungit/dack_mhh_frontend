              ...
              <div className="col">
                <div className="row d-flex flex-row align-items-end">
                  ...
                  <div className="col-lg-4 order-lg-3 order-1">
                    ...
                    <img src={require('../images/event_1.jpg')} alt="https://unsplash.com/@theunsteady5" />
                    </div>
                  </div>
                </div>	
              </div>
            ...
            <div className="row event_item">
              <div className="col">
                <div className="row d-flex flex-row align-items-end">
                  ...
                  <div className="col-lg-4 order-lg-3 order-1">
                    <div className="event_image">
                    <img src={require('../images/event_2.jpg')} alt="https://unsplash.com/@claybanks1989" />
                    </div>
                  </div>
                </div>	
              </div>
            ...
            <div className="row event_item">
              <div className="col">
                <div className="row d-flex flex-row align-items-end">
                  ...
                  <div className="col-lg-4 order-lg-3 order-1">
                    <div className="event_image">
                    <img src={require('../images/event_3.jpg')} alt="https://unsplash.com/@juanmramosjr" />
                    </div>
                  </div>
                </div>	
              </div>
